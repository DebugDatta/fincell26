...
export default function about() {
  var a = state.about;
  return shell(esc(a.title), 'Our Story',
    ...
    '</div></div>' +
    (a.leaders && a.leaders.length ? '<div class="leadership-section" style="margin-top:56px"><h3 style="margin-bottom:24px">Leadership</h3><div class="leadership-grid">' +
      a.leaders.map(function (l) {
