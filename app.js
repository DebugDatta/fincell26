...
function shell(title,eye,body){return '<section class="page"><div class="section"><div class="container">'+(eye?'<span class="eyebrow">'+eye+'</span>':'')+'<h1 class="section-title">'+title+'</h1>'+body+'</div></div></section>'}
